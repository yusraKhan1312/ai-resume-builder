...
const Features = () => {
    ...
    return (
        <div id='features' className="flex flex-col items-center my-10 scroll-mt-16 " >

            <div className="flex items-center gap-2 space-x-2.5 border border-green-500/30 rounded-full bg-green-100 p-1 text-sm text-green-600 py-1.5 px-6">
                <Zap width={14} />
                <p className="pl-3">Simple Process</p>
            </div>

            <Title
                title="Features That Help You Get Hired"
                description="Design, edit, and optimize your resume effortlessly with powerful AI-driven tools."
            />
